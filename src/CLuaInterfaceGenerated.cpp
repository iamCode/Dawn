...
** Generated automatically by tolua++-1.0.92 on 07/14/09 14:15:31.
*/
...
static int tolua_CLuaInterface_CCharacter_getStrength00(lua_State* tolua_S)
{
...
#endif
 {
...
#endif
  {
   ...
   {
#ifdef __cplusplus
    void* tolua_obj = new uint16_t(tolua_ret);
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"uint16_t");
#else
...
static int tolua_CLuaInterface_CCharacter_getLevel00(lua_State* tolua_S)
{
...
#endif
 {
...
#endif
  {
   ...
   {
#ifdef __cplusplus
    void* tolua_obj = new uint8_t(tolua_ret);
    tolua_pushusertype_and_takeownership(tolua_S,tolua_obj,"uint8_t");
#else
